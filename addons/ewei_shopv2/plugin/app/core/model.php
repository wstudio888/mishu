...
if (!(class_exists('AppModel'))) {
	class AppModel extends PluginModel
	{
		...
		public function getAuth()
		{
			...
			//cc_zhong
			load()->func('communication');
			$request = ihttp_get(EWEI_SHOPV2_AUTH_WXAPP . 'index/index/getAuth.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'].'&title='.$_W['account']['name'].$uri);
		...
		global $_W;
			...
			load()->func('communication');
			$request = ihttp_get(EWEI_SHOPV2_AUTH_WXAPP . 'index/index/getRelease.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'].$uri);
